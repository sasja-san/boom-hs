...
2. The function *definition*. What the compiler uses to make assembly.
...
So the `t` could be replaced with `List` or `Set` or `Seq` or many other types.
...
[On to the exercise](02_my_funs.qmd).
