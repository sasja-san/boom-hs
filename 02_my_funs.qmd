...
## Difficult Bonus Exercise

Import `Data.Map`^[The standard binary tree implementation.] into your program and create a one-liner (or as close as you can make it) to a tree building function:
