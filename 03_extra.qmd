...
Do your own implementations of these
...
Because Haskell lists are singly linked the access time for this is not very nice, so be careful if you actually use it.
